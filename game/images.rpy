...
## Character Sprites - Лорд Эйден Стормхолд
...
## Character Sprites - Леди Айрис Стормхолд
image char_heir_neutral = Composite(
    (400, 600),
    (0, 0), Solid("#4a2a5a", xysize=(400, 600)),
    (50, 50), Text("Леди Айрис", size=24, color="#ffffff"),
...
image char_heir_smug = Composite(
    ...
    (50, 50), Text("Леди Айрис", size=24, color="#ffffff"),
    (50, 500), Text("[Самодовольная]", size=18, color="#ffff00")
)
...
## Character Sprites - Мейстер Корвин
image char_maester_neutral = Composite(
    (400, 600),
    (0, 0), Solid("#3a3a2a", xysize=(400, 600)),
    (50, 50), Text("Мейстер Корвин", size=24, color="#ffffff"),
    (50, 500), Text("[Нейтральный]", size=18, color="#cccccc")
)
...
## Character Sprites - Кардинал Малахий
image char_cardinal_neutral = Composite(
    (400, 600),
    (0, 0), Solid("#4a4a2a", xysize=(400, 600)),
    (50, 50), Text("Кардинал Малахий", size=22, color="#ffffff"),
    (50, 500), Text("[Нейтральный]", size=18, color="#cccccc")
)
...
## Character Sprites - Торговый князь Валериан
image char_merchant_neutral = Composite(
    (400, 600),
    (0, 0), Solid("#2a4a4a", xysize=(400, 600)),
    (50, 50), Text("Князь Валериан", size=24, color="#ffffff"),
    (50, 500), Text("[Нейтральный]", size=18, color="#cccccc")
)
...
image bg_stormhold_keep = Composite(
    (1920, 1080),
    (0, 0), Solid("#1a2a3a"),
    (50, 50), Text("КРЕПОСТЬ СТОРМХОЛД", size=60, color="#ffffff"),
    (50, 150), Text("Серые каменные стены возвышаются над ледяными полями", size=24, color="#cccccc", xsize=1800)
)

image bg_throne_hall = Composite(
    (1920, 1080),
    (0, 0), Solid("#2a1a1a"),
    (50, 50), Text("ТРОННЫЙ ЗАЛ", size=60, color="#ffffff"),
    (50, 150), Text("Величественный зал с древними знамёнами", size=24, color="#cccccc")
)

image bg_north_village = Composite(
    (1920, 1080),
    (0, 0), Solid("#2a2a2a"),
    (50, 50), Text("СЕВЕРНАЯ ДЕРЕВНЯ", size=60, color="#ffffff"),
    (50, 150), Text("Небольшое поселение у подножия крепости", size=24, color="#cccccc")
)

image bg_capital_city = Composite(
    (1920, 1080),
    (0, 0), Solid("#3a2a1a"),
    (50, 50), Text("СТОЛИЦА АУРЕЛИЯ", size=60, color="#ffffff"),
    (50, 150), Text("Великая столица королевства", size=24, color="#cccccc")
)

image bg_light_cathedral = Composite(
    (1920, 1080),
    (0, 0), Solid("#3a3a2a"),
    (50, 50), Text("СОБОР ВЕЧНОГО СВЕТА", size=60, color="#ffffff"),
    (50, 150), Text("Величественный собор с золотыми куполами", size=24, color="#cccccc")
)

image bg_port_city = Composite(
    (1920, 1080),
    (0, 0), Solid("#1a2a2a"),
    (50, 50), Text("ПОРТОВЫЙ ГОРОД НЕПТАРА", size=60, color="#ffffff"),
    (50, 150), Text("Шумный портовый город на восточном побережье", size=24, color="#cccccc")
)

image bg_grand_library = Composite(
    (1920, 1080),
    (0, 0), Solid("#2a2a3a"),
    (50, 50), Text("ВЕЛИКАЯ БИБЛИОТЕКА", size=60, color="#ffffff"),
    (50, 150), Text("Древнее хранилище знаний", size=24, color="#cccccc")
)

image bg_holy_monastery = Composite(
    (1920, 1080),
    (0, 0), Solid("#3a3a3a"),
    (50, 50), Text("СВЯТОЙ МОНАСТЫРЬ", size=60, color="#ffffff"),
    (50, 150), Text("Уединённый монастырь в горах", size=24, color="#cccccc")
)

image bg_trade_hub = Composite(
    (1920, 1080),
    (0, 0), Solid("#2a3a2a"),
    (50, 50), Text("ТОРГОВЫЙ УЗЕЛ", size=60, color="#ffffff"),
    (50, 150), Text("Перекрёсток торговых путей", size=24, color="#cccccc")
)
...
image gui_main_menu = Composite(
    ...
    (760, 200), Text("ТЕНИ НАД КОРОЛЕВСТВОМ", size=60, color="#ffcc00", outlines=[(2, "#000000", 0, 0)]),
